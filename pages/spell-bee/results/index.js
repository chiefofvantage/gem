...
const Results = () => {
  ...
  const fetchStudentData = async () => {
    ...
    setLoading(true);
    const trimmedRegisterNumber = registerNumber.trim(); // Trim spaces

    console.log("Fetching data for:", trimmedRegisterNumber);

    try {
      const docRef = doc(db, "students_data", trimmedRegisterNumber);
