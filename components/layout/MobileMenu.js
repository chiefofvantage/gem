      ...
      <ul className="navigation flex  ">
        <li className={`relative  ${isdrop ? "h-[310px]" : "h-10"}`}>
          <div className="flex flex-row h-10 items-center relative ">
            <Link href="/spell-bee" className="px-3  rounded">
              Spell Bee
            </Link>
            <RiArrowDropDownLine
          ...
          <div className={`${isdrop ? "block" : "hidden"}`}>
            <ul>
              ...
              <li className=" ">
                <Link href="/spell-bee#benefits">Benefits of Spell bee</Link>
              </li>
              <li>
                <Link href="/spell-bee#categories">Categories</Link>
              </li>
              <li>
                <Link href="/spell-bee#exam-schedule">Exam Schedule</Link>
              </li>
              <li>
                <a
        ...
        <li className={`relative  ${ismbbs ? "h-[265px]" : "h-10"}`}>
          <div className="flex flex-row h-10 items-center">
            <Link className="px-3  py-2 rounded" href="/mbbs">
              Overseas MBBS
            </Link>
            <RiArrowDropDownLine
              className="absolute top-2 right-2 text-2xl"
        ...
        <li className={`relative  ${istalent ? "h-[265px]" : "h-10"}`}>
          <div className="flex flex-row h-10 items-center">
            <Link className="px-3  py-2 rounded" href="/talent-exam">
              Training Programme
            </Link>
            <RiArrowDropDownLine
              className="absolute top-2 right-2 text-2xl"
          ...
          <div>
            <ul className={`${istalent ? "block" : "hidden"}`}>
              <li>
                <Link href="/talent-exam#about-fktt">About TTP</Link>
              </li>
              <li>
                <Link href="/talent-exam#about-stp">About STP</Link>
              </li>
              <li>
                <Link href="/talent-exam#subjects">Contents Covered</Link>
              </li>
              <li className="w-full">
                <a href="/GMES-Leading With Heart for Teachers.pdf" download>
        ...
        <li className={`relative  ${isfield ? "h-[220px]" : "h-10"}`}>
          <div className="flex flex-row h-10 items-center">
            <Link className="px-3   py-2 rounded " href="/farm-guru">
              Field Trip
            </Link>
            <RiArrowDropDownLine
              className="absolute top-2 right-2 text-2xl"
          ...
          <div>
            <ul className={`${isfield ? "block" : "hidden"}`}>
              ...
              <li>
                <Link href="/farm-guru#what-we-do">What we do</Link>
              </li>
              <li>
