  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        {/* hero section */}
        <section
          className="banner-area-two banner-bg-two max-w-7xl mx-auto"
              ...
              <div className="blog__post-item-three shine__animate-item">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[#39557e] ">
                    ...
                    over vocabulary, improving their reading and writing skills.{" "}
                  </p>
                </div>
              </div>
              <div className="blog__post-item-three shine__animate-item">
            ...
            <div className="row align-items-center justify-content-center mb-55">
              <div className="col-xl-7 col-lg-8 col-md-10">
                <div className="categories__title-wrap text-center text-lg-start m-0">
                  ...
                  <p className="mb-0">
                    Our Spelling Bee features 6 distinct categories, tailored to
                    various grade levels from Class 1 to Class 10. Each category
                    provides age-appropriate challenges, fostering growth and
                    learning for every participant.
                  </p>
                </div>
              </div>
