                        ...
                        <div className="col-12">
                            <div className="cta__wrapper">
                                ...
                                <div className="tg-button-wrap justify-content-center justify-content-md-end">
                                    <Link target="_blank" href="https://api.whatsapp.com/send?phone=919840457400&text=Hello%2C%20I%20was%20exploring%20your%20website%20and%20am%20interested%20in%20learning%20more%20about%20your%20services." className="btn white-btn tg-svg"><span className="text">Connect with us</span> <span className="svg-icon" id="cta-btn" data-svg-icon="assets/img/icons/btn-arrow.svg" /></Link>
                                </div>
