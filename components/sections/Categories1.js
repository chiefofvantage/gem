                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-xl-5 col-lg-8 col-md-10">
                            <div className="categories__title-wrap text-center text-xl-start">
                                ...
                                <p>At GREY MATTER, we enhance education through a variety of programs. Our spell bee competitions have improved the vocabulary and spelling skills of over 25,000 students. We offer comprehensive guidance for students pursuing MBBS studies abroad and have successfully supported many in their journey. Our talent exams identify and nurture academic strengths, benefiting over 5,000 college students. Additionally, our field trips provide hands-on learning experiences, enriching the education of more than 35,000 students.</p>
                            ...
                            <div className="categories__wrap">
                                ...
                                <div className="row justify-content-center row-cols-2 row-cols-md-3">
                                    <div className="col">
                                        <div className="categories__item">
                                            <Link href="#services">
                                                <div className="categories__item_img" style={{ overflow: "hidden" }}><img src="/assets/img/custom/spell-bee.jpg" alt="Spell Bee" /></div>
                                    ...
                                    <div className="col">
                                        <div className="categories__item">
                                            <Link href="#services">
                                                <div className="categories__item_img" style={{ overflow: "hidden" }}><img style={{ paddingTop: "20px" }} src="/assets/img/custom/mbbs.png" alt="overseas MBBS" /></div>
                                ...
                                <div className="row justify-content-center row-cols-2 row-cols-sm-3">
                                    <div className="col">
                                        <div className="categories__item">
                                            <Link href="#services">
                                                <div className="categories__item_img" style={{ overflow: "hidden" }}><img style={{ padding: "20px" }} src="/assets/img/custom/exam.png" alt="Talen tExam" /></div>
                                    ...
                                    <div className="col">
                                        <div className="categories__item">
                                            <Link href="#services">
                                                <div className="categories__item_img" style={{ overflow: "hidden" }}><img src="/assets/img/custom/trip.webp" alt="Field Trip" /></div>
