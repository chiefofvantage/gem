            ...
            <div className="col-lg-6">
              <div className="banner__content">
                ...
                <h3 className="title tg-svg">
                  ...
                  with Excellence in Educational Upliftment
                </h3>
                <p>
                  Unlock Your Potential with GREY MATTER: Leading the Way in
                  empowering students lives
                </p>
                <div className="banner__btn-wrap">
                  ...
                  <div className="banner__phone">
                    ...
                    <div className="number-info">
                      ...
                      <h6 className="number">
                        <Link href="tel:95004-98547">95004-98547</Link>
                      </h6>
                    </div>
                  </div>
                </div>
