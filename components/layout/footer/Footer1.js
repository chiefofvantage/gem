...
export default function Footer1() {
    return (
        <>
            <footer className="footer-bg mt-6" data-bg-color="var(--tg-common-color-dark)">
                                ...
                                <div className="footer-widget">
                                    <div className="footer__about">
                                        <div className="footer__logo logo">
                                            <Link href="/"><img src="/assets/img/custom/logo.png" alt="img" /></Link>
                                        </div>
                                        <p>Supporting students in achieving their goals and beyond.</p>
                                        <ul className="list-wrap m-0 p-0">
                                            <li className="address">15, 22nd Street,
                                                Nanganallur, Chennai - 600 061.
                                            </li>
                                            <li className="number">+91 98404-57400 | +91 90875-57766</li>
                                            <li className="number">greymatteredusolutions@gmail.com
                                            </li>
