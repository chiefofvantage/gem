                    ...
                    <div className="row align-items-center justify-content-center">
                        ...
                        <div className="col-xl-6 col-lg-7">
                            <div className="about__content">
                                ...
                                <p className="desc">Established in 2017, GREY MATTER is a dynamic and emerging company dedicated to providing top-notch services in competitive tests, farm trips, management education, overseas education, and training programs. Our company is managed by a team of professionals with extensive experience in the fields of education and training. Over the years, we have proudly conducted spell bee tests for more than 25,000 students across Tamil Nadu and Andhra Pradesh, organized farm trips for over 35,000 students, and facilitated training programs for more than 5,000 school students. At GREY MATTER, we are committed to implementing modern methodologies of learning, ensuring that our sessions in schooles across Tamil Nadu are both innovative and impactful.</p>
